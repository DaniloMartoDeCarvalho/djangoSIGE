...
class DadosProdutosCompra(DadosProdutos):
    def __init__(self):
        ...
        self.get_queryset = (
            lambda self, parent_object: ItensCompra.objects.filter(compra_id=parent_object)
            or []
        )
...
class DadosPagamentoCompra(DadosPagamento):
    def __init__(self):
        ...
        self.get_queryset = (
            lambda self, parent_object: Pagamento.objects.filter(compra_id=parent_object) or []
        )
